...
<head>
    ...
    <title><?php echo PAGE_TITLE; ?> - Members</title>
...
<body class="skin-default fixed-layout">
                ...
                <div class="card">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-7 align-self-center text-right">
								<div class="d-flex justify-content-end align-items-center">
									<a class="btn btn-outline-info m-r-5" href="members-import.php"><i class="fa fa-file-excel-o m-r-5"></i> Import Members</a>
									<a class="btn btn-outline-info" href="members-add.php"><i class="fa fa-plus-circle m-r-5"></i> Add New Member</a>
								</div>
							</div>
						</div>
    ...
    $(document).ready(function() {
		...
		var initParams = {
			...
			"sAjaxSource": "inc/datatable/ajax_members.php",
			"oLanguage": {
		...
		$('#custTable').on('click', 'a.delete', function (e) {
			e.preventDefault();
			var id = $(this).attr('rel');
			var sTable = 'tbl_members';
			var sWhere = 'memb_id';
			var sStatus = 'memb_status';
			var sValue = '0';
			var nRow = $(this).parents('tr');			
			if ( confirm( "Are you sure, confirm to remove this member details?" ) ) {	
				$.ajax({
					type:'post',
					...
					complete:function(){
						$.toast({heading: 'Success!',text:'Member details successfully removed..!',position:'top-right',loaderBg:'#ff6849',icon:'success',hideAfter:2000,stack:6});
					},
