...
if(isset($_REQUEST['data'])!=''){	
	...
	if($_REQUEST['session'] != $_SESSION["_sessiondtm"]){
		...
		header("location:moi-list-print.php");			
		die();
	}
}
if($_REQUEST['view_ln'] == ""){
...
$moi_title = '';
if($_REQUEST['moi_title'] != ""){
	$moi_title = urldecode($_REQUEST['moi_title']);
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo PAGE_TITLE; ?> - Print MOI Name List</title>
...
<body class="skin-default fixed-layout">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">MOI Name List</li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="card">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-5 align-self-center">
								<h4 class="card-title">MOI Name List</h4>
							</div>
							<div class="col-md-7 align-self-center text-right">
								<div class="d-flex justify-content-end align-items-center">
									...
									<div class="row m-b-10">
										<div class="col-md-12 input-group">
											<div class="input-group-prepend">
												<span class="input-group-text">Table Title</span>
											</div>
											<input type="text" class="form-control" name="moi_title" id="moi_title" maxlength="150" placeholder="" value="<?php echo $moi_title; ?>"  />
										</div>										
									</div>
									<div class="row">
										<div class="col-md-10">
								...
								<div class="row">	
									<div class="col-md-12">
									  <div class="invoice multipage" id="print_content1">
										...
										<thead>
											<tr>
												<th colspan="6" align="center"><h4 class="moi_title text-center m-b-0 font-bold"><?php echo $moi_title; ?></h4></th>
											</tr>
											<tr>
												<th width="5%">SlNo</th>
												<th width="15%">Member No</th>
												<th width="20%">ஊர்</th>
												<th width="25%">பெயர்</th>
												<th width="25%">Name</th>
												<th width="10%">மொய்</th>
											</tr>
										</thead>
										...
										if(isset($_REQUEST['data'])!=''){
											...
											?>
												<tr>
													...
													<td><?php echo $obj->memb_fname_tamil.'. '.$obj->memb_initial_tamil;?></td>
													<td><?php echo $obj->memb_fname.'. '.$obj->memb_initial;;?></td>
													<td></td>
												</tr>	
											<?php 
											$Sno++; 
    ...
    $(document).ready(function() {
		$(".sum_export").click(function () {
			var fileName = 'MIO-Note-Name-List';
		...
		$("#moi_title").keyup(function(){
			var moi_title = $(this).val();
			$('.moi_title').html(moi_title);
		});
		...
		$("#resultForm").on("submit", function(event) {
			...
			$.ajax({
				...
				success:function(result){
					//console.log(result);
					window.location.href = "moi-list-print.php?data="+result;
				}
			});
		});
