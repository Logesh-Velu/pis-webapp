										...
										if(isset($_REQUEST['data'])!=''){
											...
											if ($pdoRes->rowCount() > 0){											
												...
												while($obj=$pdoRes->fetch()){
													...
													echo '<td class="height200" width="'.$clmWidth.'%"><span class="font-weight-bold">'.$obj->memb_fname.'. '.$obj->memb_initial.'</span><span class="memb-id">'.$obj->memb_code.'</span>'.$memb_lname.$memb_add1.$memb_add2.'																
